...
export class ImportComponent {
    ...
    hammerProc: string[] = ["None", "AnimaTouched", "PlasmaForged", "Shadowbound", "Pneumatic Maul", "Fuming Despoiler"];
    fistProc: string[] = ["None", "AnimaTouched", "PlasmaForged", "Shadowbound", "Bladed Gauntlets", "Treshing Claws", "Blood Drinkers"];
    bladeProc: string[] = ["None", "AnimaTouched", "PlasmaForged",
        "Shadowbound", "Apocalypse", "RazorsEdge", "Blade Of The Seventh Son", "Soulblade"];
    elementalProc: string[] = ["None", "AnimaTouched", "Plasma Forged", "Shadowbound",
        "UnstableElectronCore", "Frozen Figurine", "Cryo Charged Conduit"];

    bloodProc: string[] = ["None", "Anima Touched", "Plasma Forged", "Shadowbound", "EldritchTome"];
    pistolProc: string[] = ["None", "Anima Touched", "Plasma Forged", "Shadowbound", "Misery & Malice",
        "Six Shooters", "Sov-Tech Harmonisers", "CB-3Annihilators", "HeavyCaliberPistols"];
    ...
    chaosProc: string[] = ["None", "Anima Touched", "Plasma Forged", "Shadowbound",
        "Warped Visage", "Otherwordly Artifact", "Sov Tech Paradox Generator"];

    passives: string[] = ["Obliterate", "FastandFurious", "Outrage", "Berserker", "UnbridledWrath",
        "Flay", "Contaminate", "Desolate", "Defilement", "CrimsonPulse",
        "LethalAim", "Jackpot", "Beginners Luck", "Fatal Shot", "Focused Fire"];

    head: string[] = ["None", "Ashes"];
    neck: string[] = ["None", "SeedOfAgression", "Choker Of Sheed Blood", "Egon Pendant"];
    luck: string[] = ["None", "ColdSilverDice", "GamblersSoul"];
    gadget: string[] = ["None", "Electrogravitic Attractor", "Shard Of SesshoSeki", "ValiMetabolic", "Mnemonic Guardian Werewolf"];
    ...
    onSubmit(): void {
        ...
        localStorage.setItem('frmImport', JSON.stringify(this.myform.value));
