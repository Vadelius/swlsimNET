...
export class ResultComponent implements OnInit {
  ...
  energyChartData: any[] = [
    { data: this.primaryEnergy, label: "Primary", borderColor: "#d2290c" , fill: false, cubicInterpolationMode: "default", pointradius: 0},
    { data: this.secondaryEnergy, label: "Secondary", borderColor: "#c44224", fill: false, cubicInterpolationMode: "default", pointradius: 0},
  ];

  gimmickChartData: any[] = [
    { data: this.primaryGimmick, label: "Primary", borderColor: "#d2290c", fill: false, cubicInterpolationMode: "default", pointradius: 0},
    { data: this.secondaryGimmick, label: "Secondary", borderColor: "#c44224", fill: false, cubicInterpolationMode: "default", pointradius: 0},
  ];
